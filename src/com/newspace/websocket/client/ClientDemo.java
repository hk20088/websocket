...
public class ClientDemo extends WebSocketClient{
	 ...
	 *              这里测试建立连接成功后， 发送一条消息， 告诉服务器桌号和用户ID。例如：{"tableNo":"A","userId":1}
	 * @param i
	...
	{
		ClientDemo c = new ClientDemo( new URI( "ws://10.1.1.62:8080/websocket/websocket" )); 
		...
		System.out.println(String.format("桌号[%s],用户[%s]连接成功...", tableNo,i));
	...
	public ClientDemo( URI serverUri , Draft draft ) {
		super( serverUri, draft );
	}
	
	public ClientDemo(URI serverUri) {
		super(serverUri);
	}
